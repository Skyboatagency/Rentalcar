...
const AdminRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("http://http://78.47.124.12/api/admins/register", dataToSend);
  ...
  const handleVerification = async (e) => {
    ...
    try {
      const response = await axios.post("http://http://78.47.124.12/api/admins/verify", {
        userId: tempUserId,
