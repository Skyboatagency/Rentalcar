...
const texts = {
  en: {
    ...
    welcomeMessage: "Welcome to Snaibcar, your trusted partner in car rental services. Experience comfort and reliability like never before.",
    aboutUs: "At Snaibcar, we are committed to offering the best vehicles and exceptional customer service. Our fleet is constantly updated to meet your needs.",
    ...
    footerCopyright: "©2024 Snaibcar. All rights reserved.",
    whatsAppMessage: "Hello, I'd like to rent a car!",
    address: "Projet Hassane 2 imm.34 N09 Hay El Mohammadi Casablanca",
  ...
  fr: {
    ...
    welcomeMessage: "Bienvenue chez Snaibcar, votre partenaire de confiance en services de location de voitures. Vivez une expérience de confort et de fiabilité inégalée.",
    aboutUs: "Chez Snaibcar, nous nous engageons à offrir les meilleurs véhicules et un service client exceptionnel. Notre flotte est constamment mise à jour pour répondre à vos besoins.",
    ...
    footerCopyright: "©2024 Snaibcar. Tous droits réservés.",
    ...
    <div style={styles.bodyStyle}>
      ...
      <footer style={{
        ...
        <div style={{
          ...
          <div style={{ ...styles.footerColumn, gap: isMobile ? '10px' : styles.footerColumn.gap }}>
            ...
            <p style={{ ...styles.footerDescription, fontSize: isMobile ? '12px' : styles.footerDescription.fontSize }}>
              Snaibcar is your trusted partner in car rental services across Morocco. We offer a wide range of vehicles with competitive prices and exceptional service.
            </p>
            <div style={styles.socialLinks}>
              ...
              <a href="https://mail.google.com/mail/?view=cm&fs=1&to=Snaibcar@gmail.com" target="_blank" rel="noreferrer" style={styles.socialLink}>
                <FaEnvelope size={18} />
              </a>
            </div>
          </div>
          ...
          <div style={{ ...styles.footerColumn, gap: isMobile ? '10px' : styles.footerColumn.gap }}>
            ...
            <ul style={styles.footerList}>
              <li style={styles.footerListItem}>
                <span style={{ ...styles.contactInfo, fontSize: isMobile ? '12px' : styles.contactInfo.fontSize }}>Projet Hassane 2 imm.34 N09 Hay El Mohammadi Casablanca</span>
                <span style={{ ...styles.contactInfo, fontSize: isMobile ? '12px' : styles.contactInfo.fontSize }}>Casablanca, Morocco</span>
              </li>
              <li style={styles.footerListItem}>
                <span style={{ ...styles.contactInfo, fontSize: isMobile ? '12px' : styles.contactInfo.fontSize }}>Phone: +212 522 623 462</span>
                <span style={{ ...styles.contactInfo, fontSize: isMobile ? '12px' : styles.contactInfo.fontSize }}>Email: Snaibcar@gmail.com</span>
              </li>
            </ul>
        ...
        <div style={{
          ...
          <p style={{ ...styles.footerCopyright, fontSize: isMobile ? '11px' : styles.footerCopyright.fontSize }}>©2024 Snaibcar. All rights reserved</p>
        </div>
      </footer>
